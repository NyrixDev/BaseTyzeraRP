...
echo.
cd /d C:\Users\fenzo\OneDrive\Bureau\tyzerarp
C:\Users\fenzo\OneDrive\Bureau\tyzerarp\FXServer.exe +exec server.cfg
...
XCOPY C:\Users\fenzo\OneDrive\Bureau\tyzerarp C:\Users\fenzo\OneDrive\Bureau\tyzerarp-backup\ /m /e /y 
rem Changez les 2 chemins d'accès ci-dessus
echo.
...
RMDIR /s /q "C:\Users\fenzo\OneDrive\Bureau\tyzerarp\cache"
